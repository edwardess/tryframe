...
export const blogDetails = [
  ...
  // },
  {
    title: "Case Study: The Tech A Break Breakthrough using content matrix",
    image: require(".//../../public/songs/1tech.webp"),
    date: "MAY 2024",
    url: "https://wfhcouple.hashnode.dev/techabreak",
    available: true,
  },
  {
    title: "Article: How Peng Joon’s AI-Powered Strategies Supercharged Our Social Media Game",
    image: require(".//../../public/songs/peng.webp"),
    date: "SEPT 2024",
    url: "https://wfhcouple.hashnode.dev/peng-joons-ai-powers-social-media-success",
    available: true,
  },
  {
    title: "Case Study: A Deep Dive analysis into Peng Joon’s Strategic Content Matrix for Success",
    image: require(".//../../public/songs/peng2.webp"),
    date: "SEPT 2024",
    url: "https://wfhcouple.hashnode.dev/peng-joons-free-webinar-strategy",
    available: true,
  },
  // {
  //   title:
