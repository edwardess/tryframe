...
export const devProjects = [
  {
    ...
    name: "Tech A Break",
    description:
      "Boost brand awareness by targeting key audiences (TAs) with tailored content, optimizing reach through data-driven strategies, A/B testing, and programmatic ads to maximize ROI.",
    technologies: require(".//../../public/projects/techabreaklogo.webp"),
    github: "https://github.com/victorcodess/odunsi-web3-folio",
    demo: "Social Media #1",
    image: require(".//../../public/projects/techsoc.png"),
    available: false,
  },
  {
    id: 1,
    name: "Jameelah HOA",
    description:
      "Engage homebuyers for Jameelah HOA with emotion-driven content and targeted campaigns. Leverage data to showcase dream homes, boosting visibility and driving real estate sales through precise marketing.",
    technologies: require(".//../../public/projects/jameelahlogo.webp"),
    github: "https://github.com/victorcodess/interlock",
    demo: "Social Media #2",
    image: require(".//../../public/projects/jamsoc.png"),
    available: false,
  },
  {
    id: 2,
    ...
    image: require(".//../../public/projects/matrix.gif"),
    available: true,
  },
